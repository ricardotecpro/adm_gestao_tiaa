...
[![Build Status](https://github.com/ricardotecpro/adm_tiaa/actions/workflows/ci.yml/badge.svg)](https://github.com/ricardotecpro/adm_tiaa/actions)

Curso focado na integração entre tecnologia e gestão, explorando sistemas de informação, ERPs, SIGs e a nova economia digital (E-commerce).

🔗 **Acesse o curso online**: [https://ricardotecpro.github.io/adm_tiaa](https://ricardotecpro.github.io/adm_tiaa)
...
## 🛠️ Temas e Tecnologias
*   **Gestão**: ERP, CRM, BI, SIG.
*   **Comunicação**: Protocolos empresariais, SAC Digital, FAQ.
*   **Dados**: Processamento, Feedback/Realimentação, Modelos de Dados.
*   **E-commerce**: Landing Pages, Popups, E-mail Marketing, Segurança Digital.
...
1.  **Clone o repositório**:
    ```bash
    git clone https://github.com/ricardotecpro/adm_tiaa.git
    cd adm_tiaa
    ```
